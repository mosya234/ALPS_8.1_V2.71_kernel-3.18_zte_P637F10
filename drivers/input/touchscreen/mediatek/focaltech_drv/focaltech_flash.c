...
static unsigned char CTPM_FW_chuangwei[] = {
	#include "FT3327_chuangwei_app.i"
};
static unsigned char CTPM_FW_yashi[] = {
	#include "FT3427_yashi_app.i"
};
...
void fts_get_upgrade_array_CTPM_FW(void)
{
   ...
   if (vendor_id == 0xda)
    ...
    switch (vendor_id){   
        case 0x15:
            printk("[FTS] vendor  is chuangwei.\n");	
            CTPM_FW = CTPM_FW_chuangwei;
            ctpfw_filenth = sizeof(CTPM_FW_chuangwei);
            break;	
        case 0x67:
            ...
            break;     
        case 0xB5:
            printk("[FTS] vendor  is yashi. \n");
            CTPM_FW = CTPM_FW_yashi;
            ctpfw_filenth = sizeof(CTPM_FW_yashi);
            break;
        default:	
