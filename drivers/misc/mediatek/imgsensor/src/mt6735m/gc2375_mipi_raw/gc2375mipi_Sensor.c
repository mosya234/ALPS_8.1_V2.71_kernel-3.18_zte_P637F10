...
#define GC2375_DEFAULT_DUMMY_PIXEL_NUMS   0x289 //  2f8 HB
#define GC2375_DEFAULT_DUMMY_LINE_NUMS    0x10 //VB
...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        .pclk = 37500000,                //record different mode's pclk
        .linelength = 1087,                //record different mode's linelength
...
{	
	...
	hb = imgsensor.dummy_pixel + GC2375_DEFAULT_DUMMY_PIXEL_NUMS;
	vb = imgsensor.dummy_line + GC2375_DEFAULT_DUMMY_LINE_NUMS;	
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0xfe,0x00);
	write_cmos_sensor(0xfe,0x00);
	write_cmos_sensor(0xf7,0x03);// 01
	write_cmos_sensor(0xf8,0x18);// 0c
